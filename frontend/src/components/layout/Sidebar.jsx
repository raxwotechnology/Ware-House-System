...
const menuItems = [
    ...
    },
    {
        ...
        children: [
            ...
            { label: 'User Roles', path: '/roles', adminOnly: true },
    ...
    },
    {
        ...
        children: [
            ...
            { label: 'Customer Returns', path: '/returns' },
            { label: 'Repairs Workshop', path: '/repairs' },
        ],
    },
    {
        label: 'Inventory',
                    ...
                    <div className="p-6 flex items-center justify-between flex-shrink-0 bg-white">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                <h2 className="font-bold text-gray-900 text-xl tracking-tight">RC Traders</h2>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
